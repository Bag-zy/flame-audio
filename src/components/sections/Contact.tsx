        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Talk to us on Discord</h3>
                <a 
                  href="https://discord.com/invite/aFcyGJ9Y" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="inline-flex items-center px-4 py-2 mt-2 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-md transition-colors"
                >
                  Join Discord
                </a>
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Join our community for real-time support</p>
              </div>
            </div>
